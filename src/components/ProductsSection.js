...
const ProductsSection = () => {
  ...
  return (
    <div className="bg-gray-100 py-10 text-center">
      ...
      <h2 className="text-3xl font-bold mb-4 text-gray-800">Products We Offer</h2>
      ...
      <h3 className="text-2xl font-semibold mb-6 text-gray-800">Our Latest Products</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 px-6">
        {products.map((product, index) => (
          <div key={index} className="text-center">
            ...
            <h3 className="mt-2 text-lg text-gray-700">{product.title}</h3>
          </div>
        ))}
      </div>
    </div>
